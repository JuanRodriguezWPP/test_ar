...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Fn,depthTest:!1,depthWrite:!1})}function ag(s,e,t){const n=new Float32Array(hi),i=new N(0,1,0);return new Tn({name:"SphericalGaussianBlur",defines:{n:hi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${s}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Cr(),fragmentShader:`
		...
		`,blending:Fn,depthTest:!1,depthWrite:!1})}function lc(){return new Tn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Cr(),fragmentShader:`
		...
		`,blending:Fn,depthTest:!1,depthWrite:!1})}function cc(){return new Tn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Cr(),fragmentShader:`
	...
	`}class yu extends Sn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},i=[n,n,n,n,n,n];this.texture=new du(i),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),u=new Wt(l,c),h=new Rr(-1,1,1,-1,0,1);let d=null,f=null,g=!1,M,m=null,p=[],b=!1;this.setSize=function(w,S){a.setSize(w,S),o.setSize(w,S);for(let A=0;A<p.length;A++){const E=p[A];E.setSize&&E.setSize(w,S)}},this.setEffects=function(w){p=w,b=p.length>0&&p[0].isRenderPass===!0;const S=a.width,A=a.height;for(let E=0;E<p.length;E++){const R=p[E];R.setSize&&R.setSize(S,A)}},this.begin=function(w,S){if(g||w.toneMapping===Mn&&p.length===0)return!1;if(m=S,S!==null){const A=S.width,E=S.height;(a.width!==A||a.height!==E)&&this.setSize(A,E)}return b===!1&&w.setRenderTarget(a),M=w.toneMapping,w.toneMapping=Mn,!0},this.hasRenderPass=function(){return b},this.end=function(w,S){w.toneMapping=M,g=!0;let A=a,E=o;for(let R=0;R<p.length;R++){const x=p[R];if(x.enabled!==!1&&(x.render(w,E,A,S),x.needsSwap!==!1)){const T=A;A=E,E=T}}if(d!==w.outputColorSpace||f!==w.toneMapping){d=w.outputColorSpace,f=w.toneMapping,c.defines={},Ve.getTransfer(d)===$e&&(c.defines.SRGB_TRANSFER="");const R=pg[f];R&&(c.defines[R]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=A.texture,w.setRenderTarget(m),w.render(u,h),m=null,g=!1},this.isCompositing=function(){return g},this.dispose=function(){a.depthTexture&&a.depthTexture.dispose(),a.dispose(),o.dispose(),l.dispose(),c.dispose()}}const Eu=new St,mo=new Yi(1,1),Tu=new ru,bu=new jh,Au=new du,uc=[],hc=[],dc=new Float32Array(16),fc=new Float32Array(9),pc=new Float32Array(4);function ji(s,e,t){const n=s[0];if(n<=0||n>0)return s;const i=e*t;let r=uc[i];if(r===void 0&&(r=new Float32Array(i),uc[i]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,s[a].toArray(r,o)}return r}function yt(s,e){if(s.length!==e.length)return!1;for(let t=0,n=s.length;t<n;t++)if(s[t]!==e[t])return!1;return!0}function Et(s,e){for(let t=0,n=e.length;t<n;t++)s[t]=e[t]}function Pr(s,e){let t=hc[e];t===void 0&&(t=new Int32Array(e),hc[e]=t);for(let n=0;n!==e;++n)t[n]=s.allocateTextureUnit();return t}function gg(s,e){const t=this.cache;t[0]!==e&&(s.uniform1f(this.addr,e),t[0]=e)}function _g(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(yt(t,e))return;s.uniform2fv(this.addr,e),Et(t,e)}}function xg(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(yt(t,e))return;s.uniform3fv(this.addr,e),Et(t,e)}}function vg(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(yt(t,e))return;s.uniform4fv(this.addr,e),Et(t,e)}}function Mg(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(yt(t,e))return;s.uniformMatrix2fv(this.addr,!1,e),Et(t,e)}else{if(yt(t,n))return;pc.set(n),s.uniformMatrix2fv(this.addr,!1,pc),Et(t,n)}}function Sg(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(yt(t,e))return;s.uniformMatrix3fv(this.addr,!1,e),Et(t,e)}else{if(yt(t,n))return;fc.set(n),s.uniformMatrix3fv(this.addr,!1,fc),Et(t,n)}}function yg(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(yt(t,e))return;s.uniformMatrix4fv(this.addr,!1,e),Et(t,e)}else{if(yt(t,n))return;dc.set(n),s.uniformMatrix4fv(this.addr,!1,dc),Et(t,n)}}function Eg(s,e){const t=this.cache;t[0]!==e&&(s.uniform1i(this.addr,e),t[0]=e)}function Tg(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(yt(t,e))return;s.uniform2iv(this.addr,e),Et(t,e)}}function bg(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(yt(t,e))return;s.uniform3iv(this.addr,e),Et(t,e)}}function Ag(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(yt(t,e))return;s.uniform4iv(this.addr,e),Et(t,e)}}function wg(s,e){const t=this.cache;t[0]!==e&&(s.uniform1ui(this.addr,e),t[0]=e)}function Rg(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(yt(t,e))return;s.uniform2uiv(this.addr,e),Et(t,e)}}function Cg(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(yt(t,e))return;s.uniform3uiv(this.addr,e),Et(t,e)}}function Pg(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(yt(t,e))return;s.uniform4uiv(this.addr,e),Et(t,e)}}function Lg(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i);let r;this.type===s.SAMPLER_2D_SHADOW?(mo.compareFunction=t.isReversedDepthBuffer()?Po:Co,r=mo):r=Eu,t.setTexture2D(e||r,i)}function Ig(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||bu,i)}function Dg(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||Au,i)}function Ng(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||Tu,i)}function Ug(s){switch(s){case 5126:return gg;case 35664:return _g;case 35665:return xg;case 35666:return vg;case 35674:return Mg;case 35675:return Sg;case 35676:return yg;case 5124:case 35670:return Eg;case 35667:case 35671:return Tg;case 35668:case 35672:return bg;case 35669:case 35673:return Ag;case 5125:return wg;case 36294:return Rg;case 36295:return Cg;case 36296:return Pg;case 35678:case 36198:case 36298:case 36306:case 35682:return Lg;case 35679:case 36299:case 36307:return Ig;case 35680:case 36300:case 36308:case 36293:return Dg;case 36289:case 36303:case 36311:case 36292:return Ng}}function Fg(s,e){s.uniform1fv(this.addr,e)}function Og(s,e){const t=ji(e,this.size,2);s.uniform2fv(this.addr,t)}function Bg(s,e){const t=ji(e,this.size,3);s.uniform3fv(this.addr,t)}function zg(s,e){const t=ji(e,this.size,4);s.uniform4fv(this.addr,t)}function Vg(s,e){const t=ji(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,t)}function kg(s,e){const t=ji(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,t)}function Hg(s,e){const t=ji(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,t)}function Gg(s,e){s.uniform1iv(this.addr,e)}function Wg(s,e){s.uniform2iv(this.addr,e)}function Xg(s,e){s.uniform3iv(this.addr,e)}function qg(s,e){s.uniform4iv(this.addr,e)}function Yg(s,e){s.uniform1uiv(this.addr,e)}function Kg(s,e){s.uniform2uiv(this.addr,e)}function Zg(s,e){s.uniform3uiv(this.addr,e)}function $g(s,e){s.uniform4uiv(this.addr,e)}function Jg(s,e,t){const n=this.cache,i=e.length,r=Pr(t,i);yt(n,r)||(s.uniform1iv(this.addr,r),Et(n,r));let a;this.type===s.SAMPLER_2D_SHADOW?a=mo:a=Eu;for(let o=0;o!==i;++o)t.setTexture2D(e[o]||a,r[o])}function Qg(s,e,t){const n=this.cache,i=e.length,r=Pr(t,i);yt(n,r)||(s.uniform1iv(this.addr,r),Et(n,r));for(let a=0;a!==i;++a)t.setTexture3D(e[a]||bu,r[a])}function jg(s,e,t){const n=this.cache,i=e.length,r=Pr(t,i);yt(n,r)||(s.uniform1iv(this.addr,r),Et(n,r));for(let a=0;a!==i;++a)t.setTextureCube(e[a]||Au,r[a])}function e_(s,e,t){const n=this.cache,i=e.length,r=Pr(t,i);yt(n,r)||(s.uniform1iv(this.addr,r),Et(n,r));for(let a=0;a!==i;++a)t.setTexture2DArray(e[a]||Tu,r[a])}function t_(s){switch(s){case 5126:return Fg;case 35664:return Og;case 35665:return Bg;case 35666:return zg;case 35674:return Vg;case 35675:return kg;case 35676:return Hg;case 5124:case 35670:return Gg;case 35667:case 35671:return Wg;case 35668:case 35672:return Xg;case 35669:case 35673:return qg;case 5125:return Yg;case 36294:return Kg;case 36295:return Zg;case 36296:return $g;case 35678:case 36198:case 36298:case 36306:case 35682:return Jg;case 35679:case 36299:case 36307:return Qg;case 35680:case 36300:case 36308:case 36293:return jg;case 36289:case 36303:case 36311:case 36292:return e_}}class n_{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Ug(t.type)}}class i_{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=t_(t.type)}}class s_{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let r=0,a=i.length;r!==a;++r){const o=i[r];o.setValue(e,t[o.id],n)}}}const fa=/(\w+)(\])?(\[|\.)?/g;function mc(s,e){s.seq.push(e),s.map[e.id]=e}function r_(s,e,t){const n=s.name,i=n.length;for(fa.lastIndex=0;;){const r=fa.exec(n),a=fa.lastIndex;let o=r[1];const l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===i){mc(t,c===void 0?new n_(o,s,e):new i_(o,s,e));break}else{let h=t.map[o];h===void 0&&(h=new s_(o),mc(t,h)),t=h}}}class pr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){const o=e.getActiveUniform(t,a),l=e.getUniformLocation(t,o.name);r_(o,l,this)}const i=[],r=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?i.push(a):r.push(a);i.length>0&&(this.seq=i.concat(r))}setValue(e,t,n,i){const r=this.map[t];r!==void 0&&r.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let r=0,a=t.length;r!==a;++r){const o=t[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,r=e.length;i!==r;++i){const a=e[i];a.id in t&&n.push(a)}return n}}function gc(s,e,t){const n=s.createShader(e);return s.shaderSource(n,t),s.compileShader(n),n}const a_=37297;let o_=0;function l_(s,e){const t=s.split(`
`),n=[],i=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=i;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const _c=new Le;function c_(s){Ve._getMatrix(_c,Ve.workingColorSpace,s);const e=`mat3( ${_c.elements.map(t=>t.toFixed(4))} )`;switch(Ve.getTransfer(s)){case xr:return[e,"LinearTransferOETF"];case $e:return[e,"sRGBTransferOETF"];default:return Se("WebGLProgram: Unsupported color space: ",s),[e,"LinearTransferOETF"]}}function xc(s,e,t){const n=s.getShaderParameter(e,s.COMPILE_STATUS),r=(s.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";const a=/ERROR: 0:(\d+)/.exec(r);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`
...
#define LOW_PRECISION`),e}const y_={[lr]:"SHADOWMAP_TYPE_PCF",[ds]:"SHADOWMAP_TYPE_VSM"};function E_(s){return y_[s.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const T_={[gi]:"ENVMAP_TYPE_CUBE",[Wi]:"ENVMAP_TYPE_CUBE",[br]:"ENVMAP_TYPE_CUBE_UV"};function b_(s){return s.envMap===!1?"ENVMAP_TYPE_CUBE":T_[s.envMapMode]||"ENVMAP_TYPE_CUBE"}const A_={[Wi]:"ENVMAP_MODE_REFRACTION"};function w_(s){return s.envMap===!1?"ENVMAP_MODE_REFLECTION":A_[s.envMapMode]||"ENVMAP_MODE_REFLECTION"}const R_={[kc]:"ENVMAP_BLENDING_MULTIPLY",[ph]:"ENVMAP_BLENDING_MIX",[mh]:"ENVMAP_BLENDING_ADD"};function C_(s){return s.envMap===!1?"ENVMAP_BLENDING_NONE":R_[s.combine]||"ENVMAP_BLENDING_NONE"}function P_(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function L_(s,e,t,n){const i=s.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=E_(t),c=b_(t),u=w_(t),h=C_(t),d=P_(t),f=p_(t),g=m_(r),M=i.createProgram();let m,p,b=t.glslVersion?"#version "+t.glslVersion+`
...
• En Ajustes, dale permiso de cámara a Chrome/Safari.`);return}mi.srcObject=s,mi.style.display="block",await new Promise(e=>{mi.onloadedmetadata=e}),j0(),window.addEventListener("deviceorientation",tx,!0),window.addEventListener("devicemotion",nx,!0),ex(),vo.classList.remove("on"),Lu.style.display="none",Iu.style.display="block",Mo.style.display="block",ni("Cargando portal McCORMICK..."),await sx(),ni("Pulsa el botón para colocar el portal frente a ti"),Mo.addEventListener("click",rx,{once:!0}),Zt.setAnimationLoop(ax)}function j0(){Zt=new c0({antialias:!0,alpha:!0,stencil:!0,powerPreference:"high-performance"}),Zt.setPixelRatio(Math.min(window.devicePixelRatio,2)),Zt.setSize(window.innerWidth,window.innerHeight),Zt.setClearColor(0,0),Zt.autoClear=!1,document.body.appendChild(Zt.domElement),Zt.domElement.style.display="block",vn=new od,Nt=new Dt(60,window.innerWidth/window.innerHeight,.01,1e3),Nt.position.set(0,0,0),vn.add(Nt),vn.add(new Kd(16777215,4473958,1.4));const s=new vu(16777215,1);s.position.set(2,5,3),vn.add(s),window.addEventListener("resize",()=>{Nt.aspect=window.innerWidth/window.innerHeight,Nt.updateProjectionMatrix(),Zt.setSize(window.innerWidth,window.innerHeight)})}function ex(){let s=0,e=0,t=!1;document.addEventListener("touchstart",n=>{n.target.closest("button")||(s=n.touches[0].clientX,e=n.touches[0].clientY,t=!1,Dn&&(Xe!=null&&Xe.userData.onTouchStart)&&Xe.userData.onTouchStart())},{passive:!0}),document.addEventListener("touchmove",n=>{if(!Dn||!As)return;const i=n.touches[0].clientX-s,r=n.touches[0].clientY-e;!t&&(Math.abs(i)>Vc||Math.abs(r)>Vc)&&(t=!0),t&&(Xe!=null&&Xe.userData.onTouchDrag)&&(Xe.userData.onTouchDrag(i,r),s=n.touches[0].clientX,e=n.touches[0].clientY)},{passive:!0}),document.addEventListener("touchend",()=>{if(Dn&&(Xe!=null&&Xe.userData.onTouchEnd)&&Xe.userData.onTouchEnd(),!t&&Dn&&(Xe!=null&&Xe.userData.getPaprika)){const n=Xe.userData.getPaprika();if(n){vn.updateMatrixWorld(!0);const i=s/window.innerWidth*2-1,r=-(e/window.innerHeight)*2+1,a=new ff;a.setFromCamera(new ze(i,r),Nt),a.intersectObject(n,!0).find(l=>l.object.name==="CTA_Plane")&&(ni("¡Abriendo tienda McCormick!"),window.open("https://www.mccormick.com/","_blank"))}}t=!1},{passive:!0})}function tx(s){var e,t;s.alpha!==null&&(Go=!0,!Du&&(Fc.set(rn.degToRad(s.beta??0),rn.degToRad(s.alpha??0),rn.degToRad(-(s.gamma??0)),"YXZ"),an.setFromEuler(Fc),an.multiply(Nu),Er.setFromAxisAngle(Uu,-rn.degToRad(((t=(e=window.screen)==null?void 0:e.orientation)==null?void 0:t.angle)??window.orientation??0)),an.multiply(Er),Nt.quaternion.copy(an)))}function nx(s){var c,u;const e=performance.now(),t=Ma>0?Math.min((e-Ma)/1e3,.05):1/60;Ma=e;const n=s.accelerationIncludingGravity;if(!n||n.x===null)return;let i=n.x??0,r=n.y??0,a=n.z??0;const o=Math.sqrt(i*i+r*r+a*a);!Oc&&o>8.5&&o<11&&(r<-3&&(Sa=!0),(["iPad Simulator","iPhone Simulator","iPod Simulator","iPad","iPhone","iPod"].includes(navigator.platform)||navigator.userAgent.includes("Mac")&&"ontouchend"in document)&&(Sa=!0),Oc=!0),Sa&&(i=-i,r=-r,a=-a);const l=s.rotationRate;if(l&&l.alpha!==null){Du=!0,Go=!0;const h=rn.degToRad(l.beta??0),d=rn.degToRad(l.gamma??0),f=rn.degToRad(l.alpha??0);Uc<30?Uc++:rr.beta>.034&&(rr.beta=.033),rr.update(h,d,f,i,r,a,t),rr.toThreeQuat(an),an.multiply(Nu),Er.setFromAxisAngle(Uu,-rn.degToRad(((u=(c=window.screen)==null?void 0:c.orientation)==null?void 0:u.angle)??window.orientation??0)),an.multiply(Er),Nt.quaternion.copy(an)}As&&(ar=ar*.5+o*.5,!or&&ar>q0&&(or=!0),or&&ar<Y0&&(or=!1,e-Bc>K0&&(Bc=e,ix(e))))}function ix(s){if(hs.set(0,0,-1).applyQuaternion(an),hs.y=0,hs.lengthSq()<1e-4)return;hs.normalize(),Wo=s+J0,ti.addScaledVector(hs,ya*.8);const e=ti.length();e>ya*1.5&&ti.multiplyScalar(ya*1.5/e)}async function sx(){const s=new h0,{buildPortalGroup:e}=await qu(async()=>{const{buildPortalGroup:t}=await import("./portal-D7qz_0RS.js");return{buildPortalGroup:t}},[]);Xe=await e(s),vn.add(Xe),Zt.compile(vn,Nt),vn.remove(Xe)}function rx(){if(!Xe||As)return;const s=new N(0,0,-1).applyQuaternion(an);s.y=0,s.normalize(),Bi.set(s.x*3.5,-1.3,s.z*3.5),Xo.copy(s),Xe.position.copy(Bi),Xe.lookAt(0,-1.3,0),vn.add(Xe),As=!0,Oi.set(0,0,0),ti.set(0,0,0),Wo=0,Mo.style.display="none",ni("Camina hacia el portal para entrar")}function ax(s){const e=va>0?Math.min((s-va)/1e3,.05):.016;va=s,Go||Nt.rotation.set(0,0,0);const t=Oi.clone().sub(Bi),n=t.dot(Xo)+3.5;if(Xe!=null&&Xe.userData.tick&&Xe.userData.tick(s,n,an),As){const a=performance.now()<Wo?Z0:$0,o=Math.max(0,1-a*e);ti.multiplyScalar(o);const l=ti.length();if(l>.005){Oi.addScaledVector(ti,e);const c=Oi.clone().sub(Bi);c.length()>zc&&(c.clampLength(0,zc),Oi.copy(Bi).add(c));const u=Math.sin(s*.007)*Math.min(l*.035,.065);Nt.position.y=rn.lerp(Nt.position.y,u,8*e)}else ti.set(0,0,0),Nt.position.y=rn.lerp(Nt.position.y,0,5*e);Xe.position.copy(Bi).sub(Oi),ox(t)}Zt.clear(!0,!0,!0),Zt.render(vn,Nt)}function ox(s){const e=s.dot(Xo),t=e>0;if(t&&!Dn?(Dn=!0,lx()):!t&&Dn&&(Dn=!1,cx()),!Dn){const n=Math.max(0,-e).toFixed(1);n>.3?ni(`Faltan ~${n}m para entrar`):ni("Camina hacia el portal para entrar")}}function lx(){Xe.userData.setStencil&&Xe.userData.setStencil(!1),mi.style.transition="opacity 0.8s ease",mi.style.opacity="0",ni("¡Bienvenido al mundo McCORMICK!")}function cx(){Xe.userData.setStencil&&Xe.userData.setStencil(!0),mi.style.transition="opacity 0.5s ease",mi.style.opacity="1",ni("Camina hacia el portal para entrar")}function Fu(s){Dc&&(Dc.textContent=s)}function ni(s){Iu.textContent=s}function ux(s){vo.classList.add("on"),Fu(""),Nc.style.display="block",Nc.textContent=s,xa.textContent="Reintentar",xa.style.display="block",xa.addEventListener("click",()=>location.reload(),{once:!0})}export{gl as A,Ot as B,fx as C,gn as D,dx as E,fi as G,Si as K,rn as M,Ar as P,hx as R,wt as S,Yd as T,N as V,Wt as a,pi as b,pu as c,Hn as d,zo as e,Rs as f,Xi as g};
